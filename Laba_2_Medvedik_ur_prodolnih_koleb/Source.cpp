...
//const int N = 6, K = 10;
//const int Nm = N - 1;
//double L = 3.14, T = 5, a = 0.1,
//h = L / N, teta = T / K;
//double U_k[N + 1], /*U_kLANA[N + 1],*/ U_kp1[N + 1];   //матрицы для явной схемы
//double A[Nm][Nm + 1];
...
//	for (int i = 0; i <= N; i++) {
//		f1 << i * h << " " << U_k[i] << " " << AnalitRew(i * h, T) << endl;
//		cout << i * h << " " << U_k[i] << " " << AnalitRew(i * h, T) << endl;
//	}
//	f1.close();
//
//}
